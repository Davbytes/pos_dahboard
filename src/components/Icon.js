export default function Icon({ name, size = 16, color = "currentColor" }) {
  const icons = {
    home: <><rect x="3" y="9" width="18" height="13" rx="1"/><path d="M3 9l9-7 9 7"/></>,
    box: <><path d="M21 16V8l-9-5-9 5v8l9 5 9-5z"/><path d="M3.27 6.96L12 12.01l8.73-5.05M12 22.08V12"/></>,
    factory: <><path d="M2 20V10l6-4v4l6-4v4l6-4v14H2z"/><path d="M6 20v-4h4v4"/></>,
    chart: <><path d="M3 3v18h18"/><path d="M18 9l-5 5-2-2-5 5"/></>,
